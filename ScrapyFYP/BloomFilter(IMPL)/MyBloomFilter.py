...
# Example usage:
# bloom_filter = BloomFilter(capacity=1000000, error_rate=0.00001)

# Initial data
# bloom_filter.batch_add("iphone15.json")
# bloom_filter.save_to_file("bloom_filter.bin")

# Load from file
# bloom_filter_loaded = BloomFilter.load_from_file("bloom_filter.bin")
# bloom_filter_loaded.batch_add("iphone.json")
# bloom_filter_loaded.save_to_file("bloom_filter.bin")
